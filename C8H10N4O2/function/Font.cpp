//#pragma comment(lib, "DirectXTK-master/Bin/Desktop_2015/x64/Debug/DirectXTK.lib")
...
void Font::Draw(float x, float y, const wchar_t* string,float size)
{
	...
	for (size_t i = 0; i < length; ++i)
	{
		...
		currentVertex[1].position.x = positionX + info.width*size;
		...
		currentVertex[2].position.y = positionY + info.height*size;
		...
		currentVertex[3].position.x = positionX + info.width*size;
		currentVertex[3].position.y = positionY + info.height*size;
